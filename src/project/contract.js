...
- Generated by Stallone in controlled workspace mode
- Task ID: ${task.id}
...
This folder is the committed repo contract for Stallone-generated projects.
  ...
  return [
    ...
    },
    {
      ...
      content: buildSkillDoc('Workspace Hygiene', [
        'Ensure .gitignore contains the baseline Stallone ignore rules.',
